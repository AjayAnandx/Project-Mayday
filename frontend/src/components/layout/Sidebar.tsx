import { LayoutDashboard, MessageSquare, ListTodo, CalendarDays, BrainCircuit, Headphones, Plus, Search } from 'lucide-react'
import { cn } from '../../lib/utils'

export type Page = 'dashboard' | 'chat' | 'todos' | 'calendar' | 'brain' | 'voice'
